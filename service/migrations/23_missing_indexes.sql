...
CREATE INDEX IF NOT EXISTS idx_endorsements_endorser ON reputation__endorsements(endorser_id);
CREATE INDEX IF NOT EXISTS idx_denouncements_target ON trust__denouncements(target_id);
