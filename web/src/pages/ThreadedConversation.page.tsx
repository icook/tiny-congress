...
} from '../components/ThreadedConversation/ThreadedConversation';
  ...
  return {
    ...
    branches: [
      // Root message
      {
        ...
        parentId: null,
        content:
          "Welcome to our discussion on AI ethics and governance. Today we'll explore how society should regulate artificial intelligence as it becomes increasingly capable.",
        author: {
          id: 'host',
      ...
      // First level responses
      {
        ...
        parentId: 'msg1',
        content:
          'I believe AI regulation should primarily focus on transparency. Companies developing powerful AI systems should be required to disclose their capabilities, limitations, and potential risks.',
        author: {
          id: 'user1',
          name: 'Sarah Thompson',
          avatar: '',
      ...
      },
      {
        ...
        parentId: 'msg1',
        content:
          'Regulation is less important than education. We need to focus on making sure the public understands what AI can and cannot do, to prevent both irrational fears and dangerous overreliance.',
        author: {
          id: 'user2',
          name: 'Marcus Johnson',
          avatar: '',
      ...
      },
      {
        ...
        parentId: 'msg1',
        content:
          'I think we should ban AI development entirely until we have better safety protocols in place. The risks are too high.',
        author: {
          id: 'user3',
          name: 'Alex Rivera',
          avatar: '',
      ...
      // Second level - responses to the selected first level message
      {
        ...
        parentId: 'msg2',
        content:
          "Transparency is essential, but I'd add that we also need mandatory safety evaluations before deploying systems that reach certain capability thresholds. Companies should be required to demonstrate their AI systems won't cause harm before release.",
        author: {
          id: 'ai-assistant',
          name: 'AI Assistant',
          avatar: '',
      ...
      // Third level - branches after AI response
      {
        ...
        parentId: 'msg5',
        content:
          'I agree with mandatory safety evaluations, but who should perform these evaluations? A government agency might lack technical expertise, while industry self-regulation has obvious conflicts of interest.',
        author: {
          id: 'user5',
          name: 'Elena Chen',
          avatar: '',
      ...
      },
      {
        ...
        parentId: 'msg5',
        content:
          "What about international coordination? If one country imposes strict regulations but others don't, companies might just relocate their AI development to less regulated jurisdictions.",
        author: {
          id: 'user6',
          name: 'David Patel',
          avatar: '',
      ...
      },
      {
        ...
        parentId: 'msg5',
        content:
          'I think open source is the answer. If AI models and safety methods are transparent and publicly available, the entire global community can help identify and address risks.',
        author: {
          id: 'user7',
  ...
  return (
    <Container size="lg" py="xl">
      ...
      <Text mb="xl">
        ...
        conversation branches. The system will automatically select the highest-rated branch after a
        set period of time, or you can manually select branches.
      </Text>
